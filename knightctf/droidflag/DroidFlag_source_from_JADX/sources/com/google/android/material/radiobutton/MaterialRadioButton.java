...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = C0460R.style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    public MaterialRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0460R.attr.radioButtonStyle);
    }
    ...
    public MaterialRadioButton(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C0460R.styleable.MaterialRadioButton
            r6 = 0
            int[] r5 = new int[r6]
            r0 = r8
            r1 = r9
            ...
            int r10 = com.google.android.material.C0460R.styleable.MaterialRadioButton_buttonTint
        ...
        L_0x002a:
            int r8 = com.google.android.material.C0460R.styleable.MaterialRadioButton_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            int color = MaterialColors.getColor(this, C0460R.attr.colorControlActivated);
            int color2 = MaterialColors.getColor(this, C0460R.attr.colorOnSurface);
            int color3 = MaterialColors.getColor(this, C0460R.attr.colorSurface);
