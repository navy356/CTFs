...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C0460R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0460R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            ...
            int[] r2 = com.google.android.material.C0460R.styleable.SwitchMaterial
            r7 = 0
            int[] r5 = new int[r7]
            r1 = r8
            r3 = r9
            android.content.res.TypedArray r8 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r9 = com.google.android.material.C0460R.styleable.SwitchMaterial_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C0460R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C0460R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C0460R.dimen.mtrl_switch_thumb_elevation);
