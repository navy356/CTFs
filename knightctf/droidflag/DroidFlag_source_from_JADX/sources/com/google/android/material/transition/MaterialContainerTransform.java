...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        } else if (transitionValues.view.getTag(C0460R.C0463id.mtrl_motion_snapshot_view) instanceof View) {
            transitionValues.view.setTag(C0460R.C0463id.mtrl_motion_snapshot_view, (Object) null);
            transitionValues.view = (View) transitionValues.view.getTag(C0460R.C0463id.mtrl_motion_snapshot_view);
        }
    ...
    private static ShapeAppearanceModel getShapeAppearance(View view, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (view.getTag(C0460R.C0463id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C0460R.C0463id.mtrl_motion_snapshot_view);
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(new int[]{C0460R.attr.transitionShapeAppearance});
