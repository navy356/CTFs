...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C0460R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0460R.attr.chipStyle);
    }
    ...
    public Chip(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            r6.setElevation(r0)
            int[] r2 = com.google.android.material.C0460R.styleable.Chip
            r0 = 0
            int[] r5 = new int[r0]
            r0 = r8
            r1 = r9
            ...
            int r10 = com.google.android.material.C0460R.styleable.Chip_android_textColor
            ...
            r7.setTextColor(r8)
        L_0x0051:
            int r8 = com.google.android.material.C0460R.styleable.Chip_shapeAppearance
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0460R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = obtainStyledAttributes.getBoolean(C0460R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil((double) obtainStyledAttributes.getDimension(C0460R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) ViewUtils.dpToPx(getContext(), 48))));
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = C0460R.string.mtrl_chip_close_icon_content_description;
