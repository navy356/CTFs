...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C0460R.C0461color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0460R.C0461color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0460R.C0461color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0460R.C0461color.design_fab_stroke_end_outer_color));
