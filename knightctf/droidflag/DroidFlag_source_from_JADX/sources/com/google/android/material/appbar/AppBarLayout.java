...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C0460R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0460R.attr.appBarLayoutStyle);
    }
    ...
    public AppBarLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        ...
        L_0x0027:
            int[] r2 = com.google.android.material.C0460R.styleable.AppBarLayout
            int[] r5 = new int[r6]
            r0 = r7
            r1 = r11
            r3 = r12
            ...
            int r12 = com.google.android.material.C0460R.styleable.AppBarLayout_android_background
        ...
        L_0x005f:
            int r12 = com.google.android.material.C0460R.styleable.AppBarLayout_expanded
        ...
        L_0x0070:
            ...
            int r12 = com.google.android.material.C0460R.styleable.AppBarLayout_elevation
            boolean r12 = r11.hasValue(r12)
        ...
        L_0x0086:
            ...
            int r12 = com.google.android.material.C0460R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r12 = r11.hasValue(r12)
        ...
        L_0x009d:
            int r12 = com.google.android.material.C0460R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r12 = r11.hasValue(r12)
        ...
        L_0x00ae:
            int r12 = com.google.android.material.C0460R.styleable.AppBarLayout_liftOnScroll
            boolean r12 = r11.getBoolean(r12, r6)
            r9.liftOnScroll = r12
            int r12 = com.google.android.material.C0460R.styleable.AppBarLayout_liftOnScrollTargetViewId
            int r10 = r11.getResourceId(r12, r10)
            r9.liftOnScrollTargetViewId = r10
            int r10 = com.google.android.material.C0460R.styleable.AppBarLayout_statusBarForeground
    ...
    public int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? C0460R.attr.state_liftable : -C0460R.attr.state_liftable;
        iArr[1] = (!this.liftable || !this.lifted) ? -C0460R.attr.state_lifted : C0460R.attr.state_lifted;
        iArr[2] = this.liftable ? C0460R.attr.state_collapsible : -C0460R.attr.state_collapsible;
        iArr[3] = (!this.liftable || !this.lifted) ? -C0460R.attr.state_collapsed : C0460R.attr.state_collapsed;
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable materialShapeDrawable, boolean z) {
        float dimension = getResources().getDimension(C0460R.dimen.design_appbar_elevation);
        ...
        ofFloat.setDuration((long) getResources().getInteger(C0460R.integer.app_bar_elevation_anim_duration));
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0460R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C0460R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (obtainStyledAttributes.hasValue(C0460R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C0460R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0460R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C0460R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
