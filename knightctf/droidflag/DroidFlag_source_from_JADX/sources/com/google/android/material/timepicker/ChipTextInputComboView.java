...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip2 = (Chip) from.inflate(C0460R.layout.material_time_chip, this, false);
        this.chip = chip2;
        TextInputLayout textInputLayout2 = (TextInputLayout) from.inflate(C0460R.layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C0460R.C0463id.material_label);
