...
import androidx.recyclerview.C0315R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0315R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0315R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0315R.styleable.RecyclerView, attributeSet, obtainStyledAttributes, i, 0);
        }
        String string = obtainStyledAttributes.getString(C0315R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0315R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0315R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = obtainStyledAttributes.getBoolean(C0315R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0315R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0315R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0315R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0315R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C03591 r0 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
            ...
            C03602 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0315R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0315R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0315R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0315R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0315R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0315R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0315R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0315R.dimen.fastscroll_margin));
    }
