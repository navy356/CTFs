...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0141R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = obtainStyledAttributes.getString(index);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (index == C0141R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(String str) {
        ...
        if (i == 0) {
            try {
                i = C0141R.C0144id.class.getField(str).getInt((Object) null);
