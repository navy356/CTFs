...
public abstract class WidgetRun implements Dependency {
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor) {
        ...
        int i = C01341.f45x4c44d048[constraintAnchor.mTarget.mType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01341 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.widgets.analyzer.WidgetRun.C01341.<clinit>():void");
        }
    }
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor, int i) {
        ...
        int i2 = C01341.f45x4c44d048[constraintAnchor.mTarget.mType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 != 5) {
