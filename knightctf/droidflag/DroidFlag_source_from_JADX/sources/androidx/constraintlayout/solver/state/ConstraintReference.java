...
public class ConstraintReference implements Reference {
    ...
    static /* synthetic */ class C01241 {
        ...
        static {
            ...
            L_0x00b4:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.ConstraintReference.C01241.<clinit>():void");
        }
    }

    public ConstraintReference margin(int i) {
        if (this.mLast != null) {
            switch (C01241.f32x7d4bfe12[this.mLast.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = i;
                    break;
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        if (target != null) {
            int i = C01241.f32x7d4bfe12[constraint.ordinal()];
            switch (C01241.f32x7d4bfe12[constraint.ordinal()]) {
                case 1:
