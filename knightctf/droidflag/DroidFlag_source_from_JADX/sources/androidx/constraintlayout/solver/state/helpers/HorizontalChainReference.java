...
public class HorizontalChainReference extends ChainReference {
    ...
    public void apply() {
        ...
        int i = C01271.$SwitchMap$androidx$constraintlayout$solver$state$State$Chain[this.mStyle.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01271 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.helpers.HorizontalChainReference.C01271.<clinit>():void");
        }
    }
