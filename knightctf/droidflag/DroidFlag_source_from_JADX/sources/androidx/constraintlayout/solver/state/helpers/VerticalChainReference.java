...
public class VerticalChainReference extends ChainReference {
    ...
    public void apply() {
        ...
        int i = C01281.$SwitchMap$androidx$constraintlayout$solver$state$State$Chain[this.mStyle.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01281 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.helpers.VerticalChainReference.C01281.<clinit>():void");
        }
    }
