...
public class BarrierReference extends HelperReference {
    ...
    public void apply() {
        getHelperWidget();
        int i = 0;
        switch (C01261.f33xf452c4aa[this.mDirection.ordinal()]) {
            case 3:
            case 4:
                i = 1;
                break;
    ...
    static /* synthetic */ class C01261 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.helpers.BarrierReference.C01261.<clinit>():void");
        }
    }
}
