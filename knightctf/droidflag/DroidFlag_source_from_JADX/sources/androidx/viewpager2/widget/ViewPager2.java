...
import androidx.viewpager2.C0439R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        C04532 r3 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
        ...
        C04543 r4 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0439R.styleable.ViewPager2);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0439R.styleable.ViewPager2, attributeSet, obtainStyledAttributes, 0, 0);
        }
        try {
            setOrientation(obtainStyledAttributes.getInt(C0439R.styleable.ViewPager2_android_orientation, 0));
        } finally {
