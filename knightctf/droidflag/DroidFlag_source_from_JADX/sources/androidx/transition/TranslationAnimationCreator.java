...
class TranslationAnimationCreator {
    static Animator createAnimation(View view, TransitionValues transitionValues, int i, int i2, float f, float f2, float f3, float f4, TimeInterpolator timeInterpolator, Transition transition) {
        ...
        int[] iArr = (int[]) transitionValues2.view.getTag(C0393R.C0396id.transition_position);
        if (iArr != null) {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        TransitionPositionListener(View view, View view2, int i, int i2, float f, float f2) {
            ...
            this.mTerminalX = f;
            this.mTerminalY = f2;
            int[] iArr = (int[]) view2.getTag(C0393R.C0396id.transition_position);
            this.mTransitionPosition = iArr;
            if (iArr != null) {
                view2.setTag(C0393R.C0396id.transition_position, (Object) null);
            }
        }
        ...
        public void onAnimationCancel(Animator animator) {
            ...
            this.mViewInHierarchy.setTag(C0393R.C0396id.transition_position, this.mTransitionPosition);
        }
