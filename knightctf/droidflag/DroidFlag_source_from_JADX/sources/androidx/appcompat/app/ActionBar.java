...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0010R.styleable.ActionBarLayout);
            this.gravity = obtainStyledAttributes.getInt(C0010R.styleable.ActionBarLayout_android_layout_gravity, 0);
