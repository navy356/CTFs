...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0010R.C0013id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0010R.C0013id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0010R.C0013id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(C0010R.C0013id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes((AttributeSet) null, C0010R.styleable.ActionBar, C0010R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0010R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0010R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0010R.attr.actionBarWidgetTheme, typedValue, true);
