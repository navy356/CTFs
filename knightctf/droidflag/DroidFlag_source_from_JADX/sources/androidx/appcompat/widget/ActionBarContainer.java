...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0010R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0010R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0010R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0010R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0010R.C0013id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0010R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0010R.C0013id.action_bar);
        this.mContextView = findViewById(C0010R.C0013id.action_context_bar);
    }
