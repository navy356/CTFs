...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0010R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0010R.C0013id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0010R.C0013id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0010R.C0013id.action_bar));
        }
    }
