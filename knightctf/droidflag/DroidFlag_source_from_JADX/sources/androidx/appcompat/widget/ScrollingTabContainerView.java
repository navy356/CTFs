...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), (AttributeSet) null, C0010R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), (AttributeSet) null, C0010R.attr.actionDropDownStyle);
    ...
    private class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z) {
            super(context, (AttributeSet) null, C0010R.attr.actionBarTabStyle);
            int[] iArr = {16842964};
            this.BG_ATTRS = iArr;
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, (AttributeSet) null, iArr, C0010R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), (AttributeSet) null, C0010R.attr.actionBarTabTextStyle);
