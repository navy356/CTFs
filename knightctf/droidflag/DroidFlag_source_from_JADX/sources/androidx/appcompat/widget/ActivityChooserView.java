...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0010R.styleable.ActivityChooserView, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0010R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0010R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0010R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0010R.layout.abc_activity_chooser_view, this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(C0010R.C0013id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0010R.C0013id.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C0010R.C0013id.image);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0010R.C0013id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C0010R.C0013id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0010R.dimen.abc_config_prefDialogWidth));
    }
    ...
    public void showPopupUnchecked(int i) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!listPopupWindow.isShowing()) {
                ...
                listPopupWindow.getListView().setContentDescription(getContext().getString(C0010R.string.abc_activitychooserview_choose_application));
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            int itemViewType = getItemViewType(i);
            if (itemViewType == 0) {
                if (view == null || view.getId() != C0010R.C0013id.list_item) {
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0010R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                }
                PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                ((ImageView) view.findViewById(C0010R.C0013id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                ((TextView) view.findViewById(C0010R.C0013id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0010R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                inflate.setId(1);
                ((TextView) inflate.findViewById(C0010R.C0013id.title)).setText(ActivityChooserView.this.getContext().getString(C0010R.string.abc_activity_chooser_view_see_all));
                return inflate;
            }
        }
