...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0010R.layout.abc_cascading_menu_item_layout;
    ...
    public CascadingMenuPopup(Context context, View view, int i, int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0010R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0010R.layout.abc_popup_menu_header_item_layout, listView, false);
