...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        return (z || i != C0152R.C0155id.accessibility_action_clickable_span) ? z : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }

    private boolean performClickableSpanAction(int i, View view) {
        WeakReference weakReference;
        SparseArray sparseArray = (SparseArray) view.getTag(C0152R.C0155id.tag_accessibility_clickable_spans);
    ...
    static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> list = (List) view.getTag(C0152R.C0155id.tag_accessibility_actions);
