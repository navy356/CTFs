...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontsContractCompat.C01835.compare(byte[], byte[]):int");
        }
    };
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0083, code lost:
        sBackgroundThread.postAndReply(r1, new androidx.core.provider.FontsContractCompat.C01723());
     */
