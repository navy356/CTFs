...
public class LifecycleRegistry extends Lifecycle {
    ...
    static Lifecycle.State getStateAfter(Lifecycle.Event event) {
        switch (C02901.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
    ...
    static /* synthetic */ class C02901 {
        ...
        static {
            ...
            L_0x008d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C02901.<clinit>():void");
        }
    }

    private static Lifecycle.Event downEvent(Lifecycle.State state) {
        int i = C02901.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
