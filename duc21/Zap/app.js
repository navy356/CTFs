...
function zip(infile, outfile, extra_opts) {
    ...
    //console.log(extra_opts.__proto__);
    const opts = assign({
            zip: {
                password: null,
    ...
    //console.log(opts);
    //console.log(ZIP_OPTS._proto__.__pto);
    console.log(ZIP_OPTS.extra_opts || []);
    ...
    console.log([
        ...
        ...(opts.zip.password ? ["--encrypt", "--password", opts.zip.password] : []),
