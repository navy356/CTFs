...
function handle_post() {
  ...
  if (isset($name) && $name !== ""
    ...
    if ($event !== null) {
      return "event name already exists, please enter again";
    }

    insert_event($name, hash('sha256', $secret), $description);

    echo "<p>event has been added</p>";
  }
...
<form action="/add.php" method="POST">
  Name of your event: <input type="text" name="name" /><br />
